...
If the call completes without error, your SDK is configured correctly. You can now move on to [recording messages](/sdk/recording-messages) or integrate with the [Vercel AI SDK](/sdk/vercel-ai-sdk).
