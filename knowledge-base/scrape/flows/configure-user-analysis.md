# Configure user analysis

## Overview

| Property | Value |
|----------|-------|
| **Flow** | Configure user analysis |
...
This flow allows users to **configure user analysis** from the Analysis Config page.
...
Verify that the "Configure user analysis" completed successfully and the expected state change occurred.
...
```
http://localhost:3000 → /platform/[chatbotId]/analysis-config → [Configure user analysis]
```
