...
This flow allows users to **investigate dissatisfied user** from the Chatbot Dashboard page.
...
Verify that the "Investigate dissatisfied user" completed successfully and the expected state change occurred.
