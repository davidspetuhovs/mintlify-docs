...
This flow allows users to **configure translation** from the Analysis Config page.
...
### Step 2: Interact with tab: Translation

Use the **tab: Translation** element to progress through the flow.

{{screenshot_2}}

### Step 3: Verify outcome

Verify that the "Configure translation" completed successfully and the expected state change occurred.
...
```
http://localhost:3000 → /platform/[chatbotId]/analysis-config → [Configure translation]
```
