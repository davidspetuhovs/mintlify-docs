...
This flow allows users to **configure webhooks** from the Chatbot Settings page.
...
### Step 2: Interact with tab: Webhooks

Use the **tab: Webhooks** element to progress through the flow.

{{screenshot_2}}

### Step 3: Verify outcome

Verify that the "Configure webhooks" completed successfully and the expected state change occurred.
...
```
http://localhost:3000 → /platform/[chatbotId]/settings → [Configure webhooks]
```
