...
This flow allows users to **open chatbot** from the Dashboard - Chatbots List page.
...
Verify that the "Open chatbot" completed successfully and the expected state change occurred.
...
```
http://localhost:3000 → /platform → [Open chatbot]
```
