...
This flow allows users to **delete chatbot** from the Dashboard - Chatbots List page.
...
Verify that the "Delete chatbot" completed successfully and the expected state change occurred.
...
```
http://localhost:3000 → /platform → [Delete chatbot]
```
